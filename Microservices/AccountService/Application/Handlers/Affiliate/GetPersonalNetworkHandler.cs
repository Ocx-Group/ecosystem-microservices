...
public class GetPersonalNetworkHandler : IRequestHandler<GetPersonalNetworkQuery, List<AffiliatePersonalNetwork>>
{
    ...
    public GetPersonalNetworkHandler(IUserAffiliateInfoRepository repo)
    {
        _repo = repo;
    }

    // El telefono y el nivel los resuelve account_service.get_personal_network:
    // ver Data/Scripts/get_personal_network.sql.
